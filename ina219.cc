...
void Adafruit_INA219::wireWriteRegister(uint8_t reg, uint16_t value) {
    ...
    _i2c->writeByte(reg);                 // Register
    _i2c->writeByte(value >> 8 & 0xFF); // Upper 8-bits
    _i2c->writeByte(value & 0xFF);        // Lower 8-bits
    // TODO figure out how to end the transmission
...
//    _i2c->requestFrom(ina219_i2caddr, (uint8_t)2);
    ...
    *value = (_i2c->readByte() << 8 | _i2c->readByte());
}
 ...
 */
void Adafruit_INA219::begin(I2C *i2c) {
    _i2c = i2c;
    init();
}
